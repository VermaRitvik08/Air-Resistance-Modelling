...
%Getting MATLAB to do the same as Excel by finding the height, range, 
%time taken, final speed and energy lost 
...
for n = 1:N   % stop at N
    ...
    if y(n)/y(n+1) <= 0
        ...
        xf = x(n);  %units here are in m
        vf = v;     %units here are m/s
    end
end
...
%I found this on the internet and this seemed to work correctly 
%xlswrite('p3_1.xlsx',[t(:),x_ft(:),y_ft(:)],'Sheet1')